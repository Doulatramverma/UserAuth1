...
user=User.create!(First_Name: 'Rahul',Last_name:'jain',Email:'jain.rahul123@gmail.com',Company_id:company.id,Role_id:role.id,Monthly_Charge:'20000',Notes:'adadad',Active:'true' 	)
