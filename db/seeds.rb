...
user=User.create!(first_name: 'Rahul',last_name:'jain',company_id:company.id,email: 'jain.rahul123@gmail.com',role_id:role.id,monthly_charge:'20000',image:'index.jpeg2',notes:'adadad',active:'true' 	)
